...
export const App = () => (
  <Canvas shadows gl={{ antialias: false }} dpr={[1, 1.5]} camera={{ position: [0, 0, 20], fov: 35, near: 1, far: 40 }}>
    ...
    <EffectComposer disableNormalPass multisampling={0}>
      <N8AO halfRes color="black" aoRadius={8} intensity={1} aoSamples={6} denoiseSamples={4} />
      <SMAA />
    </EffectComposer>
  </Canvas>
)
...
function Clump({ mat = new THREE.Matrix4(), vec = new THREE.Vector3(), ...props }) {
  ...
  return (
    <instancedMesh ref={ref} castShadow receiveShadow args={[sphereGeometry, baubleMaterial, 150]} material-map={texture}>
